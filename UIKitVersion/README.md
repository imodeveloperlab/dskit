...
<strong style="color: yellow">Warning:</strong> Support for the UIKit version of DSKit is discontinued as the focus shifts increasingly towards SwiftUI, which offers easier development and maintenance. For more information or to migrate, please visit the <a href="URL_TO_SWIFTUI_VERSION">SwiftUI version of DSKit</a>.
