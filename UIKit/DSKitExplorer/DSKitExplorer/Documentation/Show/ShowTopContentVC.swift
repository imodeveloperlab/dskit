...
class ShowTopContentVC: DSViewController {
...
extension ShowTopContentVC: Documentable {
...
struct ShowTopContentVCPreview: PreviewProvider {
    
    static var previews: some View {
        Group {
            PreviewContainer(VC: ShowTopContentVC(), DSKitAppearance()).edgesIgnoringSafeArea(.all)
        }
    }
}
