...
class GridWithSupplementaryItemsLayoutVC: DSViewController {
...
extension GridWithSupplementaryItemsLayoutVC: Documentable {
...
struct GridWithSupplementaryItemsLayoutVCPreview: PreviewProvider {
    
    static var previews: some View {
        Group {
            PreviewContainer(VC: GridWithSupplementaryItemsLayoutVC(), DSKitAppearance()).edgesIgnoringSafeArea(.all)
        }
    }
}
